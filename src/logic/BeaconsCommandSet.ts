...
export class BeaconsCommandSet extends CommandSet {
    ...
    private makeGetBeaconByIdCommand(): ICommand {
        return new Command(
            ...
            (correlationId:string, args: Parameters, callback: (err: any, result: any) => void) => {
                ...
                this._controller.getBeaconsById(correlationId, beaconId, callback);
            }
        );
    }
    ...
    private makeCreateBeaconCommand(): ICommand {
        return new Command(
            ...
            (correlationId:string, args: Parameters, callback: (err: any, result: any) => void) => {
                ...
                this._controller.createBeacons(correlationId, beacon, callback);
            }
        );
    }
    ...
    private makeUpdateBeaconCommand(): ICommand {
        return new Command(
            ...
            (correlationId:string, args: Parameters, callback: (err: any, result: any) => void) => {
                let beacon = args.getAsObject('beacon');
                this._controller.updateBeacons(correlationId, beacon, callback);
            }
        );
    }
    ...
    private makeDeleteBeaconByIdCommand(): ICommand {
        return new Command(
            ...
            (correlationId:string, args: Parameters, callback: (err: any, result: any) => void) => {
                let beaconId = args.getAsString('beacon_id');
                this._controller.deleteBeaconsById(correlationId, beaconId, callback);
            }
        );
    }
}